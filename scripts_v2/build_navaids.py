...
Extracts VOR and NDB only from FAA 28-day NASR dataset (CSV). Output: aviation_data_v2/navaids.json.
...
def main() -> None:
    import argparse
    parser = argparse.ArgumentParser(description="Build navaids.json from NASR Navaid CSV (Phase 2 → aviation_data_v2)")
